...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**************************************************/
        mainFont.setFontText("北平市长安区看守所");
...
//        configuration.setViceFont(viceFont);
        ...
        configuration.setBorderCircle(new SealCircle(6, 100, 100));
        /**
         * 内边线粗细、半径
         */
...
//        configuration.setInnerCircle(new SealCircle(2, 85, 45));
        ...
        //1.生成公章
        try {
            SealUtil.buildAndStoreSeal(configuration, "C:\\Users\\何明会\\Desktop\\1\\公章1.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "C:\\Users\\何明会\\Desktop\\SealUtil-master\\test\\私章.png");
    }
